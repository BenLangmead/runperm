...
class runperm_fl_impl : public runperm_rlbwt<runperm_fl_impl<data_columns_t, integrated_move_structure, store_absolute_positions, exponential_search, alphabet_t, table_t>,
...
template<bool store_absolute_positions = DEFAULT_STORE_ABSOLUTE_POSITIONS,
         ...
         typename alphabet_t = nucleotide,
         template<typename> class table_t = move_vector>
class move_fl_impl : public moveperm_rlbwt<runperm_fl_impl<empty_data_columns, false, store_absolute_positions, exponential_search, alphabet_t, table_t>, 
                    store_absolute_positions, exponential_search, alphabet_t, table_t> {
using base = moveperm_rlbwt<runperm_fl_impl<empty_data_columns, false, store_absolute_positions, exponential_search, alphabet_t, table_t>,
            store_absolute_positions, exponential_search, alphabet_t, table_t>;
public:
    using base::base;
    using base::operator=;
